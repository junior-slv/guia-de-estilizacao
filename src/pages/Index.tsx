...
const Index = () => {
  return (
    <Container>
      <div className="justify-around w-screen grid grid-rows-2 items-center sm:grid-rows-2 font-roboto bg-purple-room bg-no-repeat md:bg-cover bg-cover bg-fixed ">
